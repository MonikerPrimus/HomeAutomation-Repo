...
.buttonRainbow { background-color: #E6A7B9; border: 2px solid #000000;; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; }
...
<br><br>
<center> <button class="buttonRainbow" name="led" value="rainbow" type="submit">LED RAINBOW</button>
</form>
<br><br>
<br><br>
<p>%s<p></body></html>
